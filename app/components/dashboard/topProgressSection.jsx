...
const TopProgressSection = () => {
  ...
  return (
    <section id='topProgressSection' className='grid gap-4   min-[1400px]:grid-cols-4   md:grid-cols-2 md:grid-rows-1   grid-cols-1 grid-rows-2'>
      {/* {console.log('isPending', isPending, countState)} */}
          ...
          <Card.Body className=''>
              ...
              <div className='flex items-center flex-row gap-4'>
                ...
                <div className='flex items-start flex-col'>
                  {/* <span className='text-2xl font-bold text-asd_black'>13/26</span> */}
                  {/* With integration */}
              ...
              <div className='flex items-center flex-col gap-2 pt-10'>
                <div className='flex items-center justify-between flex-row gap-2 w-full'>
                  ...
                  {/* <span className='text-xs font-normal text-asd_black'>EGP5,750 <span className='ml-2 !text-gray-500'>(65%)</span> </span> */}
                  {/* With integration */}
                ...
                {/* <ProgressBar now={65} className={`w-full !h-[3px] bg-gray-200 ${progressColors[index]}`} /> */}
                {/* With integration */}
